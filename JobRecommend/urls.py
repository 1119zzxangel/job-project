...
urlpatterns = [
    ...
    path('add_model/', views.add_model, name="add_model"),  # 添加模型接口
    path('update_model/', views.update_model, name="update_model"),  # 更新模型接口
    path('delete_model/', views.delete_model, name="delete_model"),  # 删除模型接口
    path('switch_model/', views.switch_model, name="switch_model"),  # 切换模型接口
